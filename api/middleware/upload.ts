...
import { ossService } from '../config/oss';
 ...
 * 验证图片尺寸
 */
export const validateImageDimensions = (minWidth: number = 100, minHeight: number = 100, maxWidth: number = 8000, maxHeight: number = 8000) => {
